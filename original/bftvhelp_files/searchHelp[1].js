...
if ((e.id=="searchBox" || e.parentElement.id=="searchBox") && (helpMsg.style.visibility=="hidden"))
       helpMsg.style.visibility="visible";
else helpMsg.style.visibility="hidden";	
